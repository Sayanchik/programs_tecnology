...
namespace online_shop.Domain.ValueObjects.Base
{
    public abstract class ValueObject<T> : IEquatable<ValueObject<T>>
    {
        ...
        {
            if (validator == null)
                throw new ValidatorNullException(GetType().FullName ?? String.Empty, ExeptionMessages.VALIDATOR_MUST_BE_SPECIFIED);
